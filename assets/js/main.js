const COMMON = {
  es: {
    ...
    'project.2.index':'Caso 02 · Databricks & Power BI','project.2.title':'SMAP Transformation Migration','project.2.desc':'Migración de la lógica de Power Query a Databricks para calcular, ordenar y reutilizar jerarquías de gasto consumidas por un reporte dinámico de Power BI.','project.2.stat':'jerarquías de ordenamiento consolidadas en una tabla reutilizable','project.2.cta':'Ver caso de estudio',
    'project.3.index':'Caso 03 · Excel & VBA','project.3.title':'LHCSA Aide Manager','project.3.desc':'Aplicación en Excel VBA para registrar, buscar y actualizar cuidadores según disponibilidad, idioma, ubicación y condiciones del caso.','project.3.stat':'campos operativos centralizados en un solo modelo','project.3.cta':'Ver caso de estudio',
  ...
  en: {
    ...
    'project.2.index':'Case 02 · Databricks & Power BI','project.2.title':'SMAP Transformation Migration','project.2.desc':'Migration of Power Query logic into Databricks to calculate, rank and reuse spend hierarchies consumed by a dynamic Power BI report.','project.2.stat':'sorting hierarchies consolidated into one reusable table','project.2.cta':'View case study',
    'project.3.index':'Case 03 · Excel & VBA','project.3.title':'LHCSA Aide Manager','project.3.desc':'Excel VBA application to register, search and update caregivers by availability, language, location and case conditions.','project.3.stat':'operational fields centralized in one model','project.3.cta':'View case study',
